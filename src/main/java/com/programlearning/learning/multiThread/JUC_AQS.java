...
public class JUC_AQS {
    ...
    public static final int clientCount = 3;
     ...
     */
    private static CyclicBarrier cyclicBarrier = new CyclicBarrier(totalThread);

    /**
     * Semaphore 类似于操作系统中的信号量，可以控制对互斥资源的访问线程数。
     */
    private static Semaphore semaphore = new Semaphore(clientCount);
